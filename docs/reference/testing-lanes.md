...
Two assertions, both structural. Neither scans for values that _look_ suspicious; a deny-list is the heuristic [`../decisions/ADR-0069-redaction-is-by-construction.md`](../decisions/ADR-0069-redaction-is-by-construction.md) refused for redaction, and it has the same unbounded tail here.
