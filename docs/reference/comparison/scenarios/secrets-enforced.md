...
The companion to [the row above](./secrets-in-the-build.md). A documented flow that keeps credentials out of the artifact is worth having; this row asks what happens to the user who ignores it.
