...
| `guest-balloon-supported`  | virtualization | the guest kernel this project would boot lacks the balloon driver, and with it the free-page reporting that makes declared memory a ceiling rather than a reservation (N22)                           |
