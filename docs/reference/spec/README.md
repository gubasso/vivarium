...
- [`15-project-identity.md`](./15-project-identity.md) — the single source of truth for the project-identity key: the name-based derivation, the gitignored `.vivarium/` marker, and the resolution algorithm that keeps identity stable across moves, renames, copies, and clones.
