...
| `65` | `EX_DATAERR`     | The merged configuration carries a defect vivarium's own rules reject: irreconcilable (one volume name bound to two mountpoints), an equal-priority scalar tie, or a literal personal path in a shared image or piece (N11). See ADR-0042. |
