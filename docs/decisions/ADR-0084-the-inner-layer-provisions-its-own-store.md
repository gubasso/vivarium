...
- The share is boot-closure delivery, not package sharing. ADR-0038 chose it over a per-VM store image on disk and build cost; the guest's root filesystem is host store paths, and package sharing was never what it bought.
