...
Chosen option: per-VM network namespace with a gating resolver — it is the only option that survives an adversarial guest and a name whose addresses move.
