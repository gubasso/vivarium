...
Enacted by [slice 017](../plan/slices/017-doctor-catalog/README.md): the catalog lives in `src/doctor/`, `viv doctor` reports it, and the preflight guard consumes its hard subset.
