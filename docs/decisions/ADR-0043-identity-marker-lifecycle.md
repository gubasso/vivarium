...
Amends [`ADR-0018-lifecycle-verbs-and-teardown-boundary.md`](./ADR-0018-lifecycle-verbs-and-teardown-boundary.md) and [`ADR-0029-project-identity-and-marker.md`](./ADR-0029-project-identity-and-marker.md). Specified in [`../reference/spec/01-command-surface.md`](../reference/spec/01-command-surface.md), [`../reference/spec/10-vm-lifecycle.md`](../reference/spec/10-vm-lifecycle.md), [`../reference/spec/14-exit-codes.md`](../reference/spec/14-exit-codes.md), and `../reference/spec/15-project-identity.md`.
