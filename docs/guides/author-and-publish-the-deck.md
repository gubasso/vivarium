...
The vivarium presentation deck lives in [`../../slides/`](../../slides/README.md) and is published to <https://gubasso.github.io/vivarium/>. This is the runbook for changing it and getting the change live. [`../decisions/ADR-0103-the-published-deck-is-its-own-presentation-tree.md`](../decisions/ADR-0103-the-published-deck-is-its-own-presentation-tree.md) owns why the deck sits outside the documentation zones and why the repository's Markdown rules do not reach it.
...
| `slidev-build` fails at push naming a missing script               | `slides/node_modules` is absent. Run `just slides-install`.                                                                                                                                           |
