...
- [ADR-0051](../decisions/ADR-0051-share-worker-pool-small-non-zero-uniform.md) — fixes the small, non-zero, uniform worker pool.
...
- [Q-002](../plan/open-questions.md#q-002--which-small-non-zero-share-worker-pool-survives-a-genuinely-concurrent-workload) and [slice 001](../plan/slices/001-close-host-measurement-gaps/README.md) own the concurrent worker-pool measurement.
